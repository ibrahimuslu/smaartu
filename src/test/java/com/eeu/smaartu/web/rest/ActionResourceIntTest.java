...
public class ActionResourceIntTest {
    ...
    private static final UnitStatus DEFAULT_CONDITION = UnitStatus.START;
    private static final UnitStatus UPDATED_CONDITION = UnitStatus.STOP;

    private static final UnitStatus DEFAULT_ACTION_STATUS = UnitStatus.START;
    private static final UnitStatus UPDATED_ACTION_STATUS = UnitStatus.STOP;
    ...
    public void createAction() throws Exception {
        ...
        assertThat(testAction.getCondition()).isEqualTo(DEFAULT_CONDITION);
    ...
    public void updateAction() throws Exception {
        ...
        Action testAction = actionList.get(actionList.size() - 1);
        assertThat(testAction.getCondition()).isEqualTo(UPDATED_CONDITION);
